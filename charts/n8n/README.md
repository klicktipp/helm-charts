...
![Version: 1.11.0](https://img.shields.io/badge/Version-1.11.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 2.28.0](https://img.shields.io/badge/AppVersion-2.28.0-informational?style=flat-square)
...
| main.runner.extraVolumeMounts | list | `[]` | Additional volume mounts for main task runner sidecar. |
...
| worker.runner.extraVolumeMounts | list | `[]` | Additional volume mounts for worker task runner sidecar (appended to runners.extraVolumeMounts). |
