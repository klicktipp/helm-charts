...
| transparentDNS.interceptor.installPackagesCommand | string | `"apk add --no-cache iptables iproute2"` | Package installation command executed before configuring iptables rules. Ignored when interceptor.enableRuntimeInstall=false. |
